# Generated by Powerlevel10k configuration wizard on 2023-03-24 at 14:36 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=71
  # Custom icon.
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=65
